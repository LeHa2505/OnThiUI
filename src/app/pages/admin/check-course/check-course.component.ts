...
@Component({
  ...
  styleUrls: ['./check-course.component.less'],
})
export class CheckCourseComponent {
  activeTab = 1;
  idCourse: number;
  ...
  closeCourse() {
    this.modal.confirm({
      nzTitle: 'Bạn có chắc chắn khóa khóa học này?',
      nzOkText: 'Có',
      nzOkType: 'primary',
      nzOkDanger: true,
      nzCentered: true,
  ...
  openCourse() {
    this.modal.confirm({
      nzTitle: 'Bạn có chắc chắn mở khóa khóa học này?',
      nzOkText: 'Có',
      nzOkType: 'primary',
      nzCentered: true,
      nzOkDanger: true,
